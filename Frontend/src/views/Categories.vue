  ...
  <div class="dashboard-layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav-links">
        ...
        <router-link v-if="!authStore.isSuperadmin && authStore.hasPermission('categorias')" to="/categories" class="nav-item active">🏷️ <span class="sidebar-text">Categorías</span></router-link>
