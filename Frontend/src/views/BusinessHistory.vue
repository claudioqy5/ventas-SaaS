  ...
  <div class="dashboard-layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav-links">
        ...
        <router-link v-if="!authStore.isSuperadmin && authStore.hasPermission('dashboard')" to="/business-history" class="nav-item active">📈 <span class="sidebar-text">Historial de Negocio</span></router-link>
