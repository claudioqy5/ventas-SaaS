  ...
  <div class="dashboard-layout">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav-links">
        ...
        <router-link v-if="!authStore.isSuperadmin && (authStore.hasPermission('historial_ventas') || authStore.hasPermission('ventas'))" to="/online-orders" class="nav-item" active-class="active">
